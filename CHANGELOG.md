...
- Added `io.vitrallis.fireflyfield` `0.2.0`: Publish the SDL2-rendered ambient meadow with verified renderer selection, keyboard controls, performance statistics, color moods and adjustable wind. [App changelog](apps/firefly-field/CHANGELOG.md).
