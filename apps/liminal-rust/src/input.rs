    ...
    pub fn handle_event(&mut self, event: &Event) {
        match event {
            ...
            Event::KeyDown {
                ...
                Keycode::S => self.state.move_backward = true,
                Keycode::D => self.state.strafe_right = true,
                Keycode::Z => self.state.move_backward = true,
                Keycode::Q => self.state.look_left = true,
                Keycode::E => self.state.look_right = true,
            ...
            Event::KeyUp {
                ...
                Keycode::S => self.state.move_backward = false,
                Keycode::D => self.state.strafe_right = false,
                Keycode::Z => self.state.move_backward = false,
                Keycode::Q => self.state.look_left = false,
                Keycode::E => self.state.look_right = false,
